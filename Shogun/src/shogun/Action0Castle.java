 ...
 * @author Imrihil
 */
public class Action0Castle extends Action {

    public Action0Castle() throws IOException {
        super("Castle", new Picture("/img/small/card/action/action0.png"), new Picture("/img/large/card/action/action0.png"), new Picture("/img/large/card/action/doing/accept.png"), new Picture("/img/large/card/action/doing/acceptNoAvailable.png"), new Picture("/img/large/card/action/doing/decline.png"), new Picture("/img/large/card/action/doing/choose_highlighted.png"), new Picture("/img/large/card/action/doing/action0.png"), 527, 114);
    }
    ...
    public void doAction(GameStep3Game gameStep, MyJFrame window, List<Daimyo> daimyos) {
        ...
        while (true) {
            ...
            if (GameStep3Game.activeDaimyo.getStatus() > 0) {
                GameStep3Game.activeDaimyo.getAI().doAction0Castle(GameStep3Game.activeDaimyo, super.isPossible(), this);
            }
    ...
    public void mouseClicked(MouseEvent e) {
        if (super.getChoose() == 1) {
            GameStep3Game.activeDaimyo.getActionProvince(super.getName()).addBuildings(Building.CASTLE);
    ...
    private boolean possible() {
        if (GameStep3Game.activeDaimyo.getActionProvince(super.getName()) != null && GameStep3Game.activeDaimyo.getGold() >= 3) {
