 ...
 * @author Imrihil
 */
public class Action8MoveA extends Action {

    public Action8MoveA() throws IOException {
        super("MoveA", new Picture("/img/small/card/action/action8.png"), new Picture("/img/large/card/action/action8.png"), new Picture("/img/large/card/action/doing/accept.png"), new Picture("/img/large/card/action/doing/acceptNoAvailable.png"), new Picture("/img/large/card/action/doing/decline.png"), new Picture("/img/large/card/action/doing/choose_highlighted.png"), new Picture("/img/large/card/action/doing/action8.png"), 862, 290);
    }
    ...
    public static boolean canAttack(Province province) {
