 ...
 * @author Imrihil
 */
public class Action4Gold extends Action {

    public Action4Gold() throws IOException {
        super("Gold", new Picture("/img/small/card/action/action4.png"), new Picture("/img/large/card/action/action4.png"), new Picture("/img/large/card/action/doing/accept.png"), new Picture("/img/large/card/action/doing/acceptNoAvailable.png"), new Picture("/img/large/card/action/doing/decline.png"), new Picture("/img/large/card/action/doing/choose_highlighted.png"), new Picture("/img/large/card/action/doing/action4.png"), 974, 114);
    }
    ...
    public void doAction(GameStep3Game gameStep, MyJFrame window, List<Daimyo> daimyos) {
        ...
        while (true) {
            ...
            if (GameStep3Game.activeDaimyo.getStatus() > 0) {
                GameStep3Game.activeDaimyo.getAI().doAction4Gold(GameStep3Game.activeDaimyo, super.isPossible(), this);
            }
    ...
    public void mouseClicked(MouseEvent e) {
        if (super.getChoose() == 1) {
            //System.out.printf("Daimyo %d miał %d złota, otrzymał %d, więc teraz posiada %d złota.\n", GameStep3Game.activeDaimyo.getId(), GameStep3Game.activeDaimyo.getGold(), max(min(GameStep3Game.activeDaimyo.getActionProvince(super.getName()).getGold(), Shogun.allEvents.get(GameStep3Game.turnNr).getMaxGold()), Shogun.allEvents.get(GameStep3Game.turnNr).getMinGold()) + GameStep3Game.activeDaimyo.getSpecial().getGoldBonus(), GameStep3Game.activeDaimyo.getGold() + max(min(GameStep3Game.activeDaimyo.getActionProvince(super.getName()).getGold(), Shogun.allEvents.get(GameStep3Game.turnNr).getMaxGold()), Shogun.allEvents.get(GameStep3Game.turnNr).getMinGold()) + GameStep3Game.activeDaimyo.getSpecial().getGoldBonus());
            GameStep3Game.activeDaimyo.setGold(GameStep3Game.activeDaimyo.getGold() + max(min(GameStep3Game.activeDaimyo.getActionProvince(super.getName()).getGold(), Shogun.allEvents.get(GameStep3Game.turnNr).getMaxGold()), Shogun.allEvents.get(GameStep3Game.turnNr).getMinGold()) + GameStep3Game.activeDaimyo.getSpecial().getGoldBonus());
