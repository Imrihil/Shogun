 ...
 * @author Imrihil
 */
public class Action1Temple extends Action {

    public Action1Temple() throws IOException {
        super("Temple", new Picture("/img/small/card/action/action1.png"), new Picture("/img/large/card/action/action1.png"), new Picture("/img/large/card/action/doing/accept.png"), new Picture("/img/large/card/action/doing/acceptNoAvailable.png"), new Picture("/img/large/card/action/doing/decline.png"), new Picture("/img/large/card/action/doing/choose_highlighted.png"), new Picture("/img/large/card/action/doing/action1.png"), 638, 114);
    }
    ...
    public void doAction(GameStep3Game gameStep, MyJFrame window, List<Daimyo> daimyos) {
        ...
        while (true) {
            ...
            if (GameStep3Game.activeDaimyo.getStatus() > 0) {
                GameStep3Game.activeDaimyo.getAI().doAction1Temple(GameStep3Game.activeDaimyo, super.isPossible(), this);
            }
    ...
    public void mouseClicked(MouseEvent e) {
        if (super.getChoose() == 1) {
            GameStep3Game.activeDaimyo.getActionProvince(super.getName()).addBuildings(Building.TEMPLE);
    ...
    private boolean possible() {
        if (GameStep3Game.activeDaimyo.getActionProvince(super.getName()) != null && GameStep3Game.activeDaimyo.getGold() >= 2) {
