 ...
 * @author Imrihil
 */
public class Action2Theatre extends Action {

    public Action2Theatre() throws IOException {
        super("Theatre", new Picture("/img/small/card/action/action2.png"), new Picture("/img/large/card/action/action2.png"), new Picture("/img/large/card/action/doing/accept.png"), new Picture("/img/large/card/action/doing/acceptNoAvailable.png"), new Picture("/img/large/card/action/doing/decline.png"), new Picture("/img/large/card/action/doing/choose_highlighted.png"), new Picture("/img/large/card/action/doing/action2.png"), 749, 114);
    }
    ...
    public void doAction(GameStep3Game gameStep, MyJFrame window, List<Daimyo> daimyos) {
        ...
        while (true) {
            ...
            if (GameStep3Game.activeDaimyo.getStatus() > 0) {
                GameStep3Game.activeDaimyo.getAI().doAction2Theatre(GameStep3Game.activeDaimyo, super.isPossible(), this);
            }
    ...
    public void mouseClicked(MouseEvent e) {
        if (super.getChoose() == 1) {
            GameStep3Game.activeDaimyo.getActionProvince(super.getName()).addBuildings(Building.THEATRE);
            GameStep3Game.activeDaimyo.getActionProvince(super.getName()).setRevolt(min(0, GameStep3Game.activeDaimyo.getActionProvince(super.getName()).getRevolt() - Shogun.allEvents.get(GameStep3Game.turnNr).getRevolt()));
    ...
    private boolean possible() {
        if (GameStep3Game.activeDaimyo.getActionProvince(super.getName()) != null && GameStep3Game.activeDaimyo.getGold() >= 1) {
            for (Place place : GameStep3Game.activeDaimyo.getActionProvince(super.getName()).getBuildings()) {
